 ...
 *
 */
public class TCircle extends TDraw {
	 ...
	 * @param drawRaphael
	 */
	public TCircle(int x, int y, int radius, String backgroundColor,
			String borderColor, String drawRaphael, int index) {
		this.x = x;
		this.y = y;
		this.radius = radius;
	...
	public String getJavascript(){
		return drawRaphael+".circle("+x+","+y+","+radius+")"+
