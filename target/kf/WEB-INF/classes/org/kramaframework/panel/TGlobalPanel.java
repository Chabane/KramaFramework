...
import org.kramaframework.exception.KramaUnknownJavascriptDependancyException;
			...
			JsDpendency jsDependency = TAjaxServlet.dependency.getDependencyByName((String)dependancy);
			 try {
					if(jsDependency !=null){		
						...
						throw new KramaUnknownJavascriptDependancyException(jsDependency+" dependency was not found by Krama");
					
			  } catch (KramaUnknownJavascriptDependancyException e) {
					e.printStackTrace();
			  }
		}
		return script;
